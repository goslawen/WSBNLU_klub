...
@section('title', 'CzĹ‚onkowie - WSBNLU Klub')

@section('content')
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h1 class="h3 mb-0">CzĹ‚onkowie</h1>
        <a href="{{ route('members.create') }}" class="btn btn-primary">Dodaj czĹ‚onka</a>
    </div>
    ...
    <form method="GET" action="{{ route('members.index') }}" class="row g-2 mb-3">
        ...
        <div class="col-md-3 d-flex gap-2">
            ...
            <a href="{{ route('members.index') }}" class="btn btn-outline-secondary">WyczyĹ›Ä‡</a>
        </div>
    </form>
            ...
            <tbody>
                @forelse ($members as $member)
                    <tr>
                        ...
                        <td>{{ $member->status === 'active' ? 'aktywny' : 'nieaktywny' }}</td>
                        <td class="text-end">
                            <a href="{{ route('members.show', $member) }}" class="btn btn-sm btn-outline-secondary">PodglÄ…d</a>
                ...
                @empty
                    <tr>
                        <td colspan="7" class="text-center text-muted">Brak czĹ‚onkĂłw do wyĹ›wietlenia.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
